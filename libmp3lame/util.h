...
#  define  LAME_ID   0xFFF88E3B
		...
		/* jabarouti:*/
		lame_internal_flags *internal_flags_overlapped;
		struct {
			int ntotal_frame_number;
			int nextra_frame_number;
			int frame_number_to_combine;
			int location_to_combine;
			int counter_next_frame;
			int finished_encoding_condition;
			int is_overlapeed_multithreaded;
			int find_the_solution;
		} next_chunk;
