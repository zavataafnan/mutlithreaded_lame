...
/* adding by jabarouti 
* get the previous main data for the overlapped section 
*/
int CDECL lame_set_previous_internal_flag(lame_global_flags * gfp, lame_global_flags * overlapped_gfp);
int CDECL lame_set_next_chunk_of_data(lame_global_flags * gfp, int main_number, int extra_number);
int CDECL lame_set_multithread_overlapped(lame_global_flags * gfp, int status);
int CDECL lame_get_multithread_parameters(lame_global_flags * gfp, int * byte_number_to_truncate);
